<section class="space-y-4">
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-5">
        ...
        <div class="space-y-2">
            ...
            <x-input-error :messages="$errors->updatePassword->get('current_password')" class="text-xs text-red-600" />
        </div>
        ...
        <div class="space-y-2">
            ...
            <x-input-error :messages="$errors->updatePassword->get('password')" class="text-xs text-red-600" />
        </div>
        ...
        <div class="space-y-2">
            ...
            <x-input-error :messages="$errors->updatePassword->get('password_confirmation')" class="text-xs text-red-600" />
        </div>
