<section class="space-y-4">
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-5">
        ...
        <div class="space-y-2">
            ...
            <input id="whatsapp" name="whatsapp" type="tel" class="w-full rounded-xl border border-slate-200 px-3 py-2.5 text-sm focus:border-teal-300 focus:outline-none focus:ring-2 focus:ring-emerald-200" value="{{ old('whatsapp', $user->whatsapp) }}" inputmode="numeric" autocomplete="tel" placeholder="08xxxxxxxxxx" />
            <x-input-error class="text-xs text-brand-maroon" :messages="$errors->get('whatsapp')" />
        </div>
