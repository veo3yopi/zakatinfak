                ...
                <div class="rounded-2xl border border-slate-100 bg-white p-5 shadow-sm">
                    ...
                    <form method="POST" action="{{ route('programs.show', $program->slug) }}" class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea name="message" rows="3" class="mt-1 w-full rounded-xl border border-slate-200 px-3 py-2 text-sm focus:border-teal-300 focus:outline-none focus:ring-2 focus:ring-emerald-200" placeholder="Doa atau tujuan donasi">{{ old('message') }}</textarea>
