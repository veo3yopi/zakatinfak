    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between py-4">
            ...
            <div class="flex items-center gap-3">
                ...
                @endif
                <a href="{{ route('programs') }}" class="hidden sm:inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-teal-500 to-emerald-400 px-4 py-2 text-sm font-semibold text-white shadow-lg shadow-teal-500/20 hover:shadow-teal-500/30 transition">
                    Lihat Program
    ...
    <section class="mt-8 rounded-3xl bg-white shadow-lg shadow-slate-200/70 p-6 sm:p-8 space-y-6">
        <div class="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            ...
            <form action="{{ route('search') }}" method="GET" class="w-full md:w-auto flex gap-3">
                ...
                <button type="submit" class="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-emerald-400 to-teal-500 px-4 py-2.5 text-sm font-semibold text-slate-900 shadow-md hover:shadow-lg transition">
                    Cari
                </button>
            </form>
        </div>
